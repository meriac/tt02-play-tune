...
Listen to the [Verilog Simulation PWM output for 10kHz sampling frequency](https://github.com/meriac/tt02-play-tune/releases/download/v0.1/tune-modulation-verilog-simulated.wav) here.
...
## How To Test ##
Provide 10kHz clock on io_in[0], briefly hit reset io_in[1] (Low, High, Low)
